...
interface ReturnsReportPreviewProps {
    ...
    employeeName: string;
    date: string;
    receiverName: string; // warehouse staff or generic
}

const ReturnsReportPreview = ({ data, employeeName, date, receiverName }: ReturnsReportPreviewProps) => {
    ...
    return (
        <Box sx={{ position: 'relative' }}>
            ...
            <div id="returns-preview-content">
                <Box sx={{
                    bgcolor: 'white',
                    color: 'black',
                    maxWidth: '210mm',
                    ...
                    <Box sx={{ mb: 2, fontSize: '13px' }}>
                        <Typography fontWeight="bold" mb={0.5} sx={{ color: '#1976d2' }}>1. BÊN GIAO (BÊN TRẢ HÀNG):</Typography>
                        <Box ml={3}>
                            <Typography gutterBottom sx={{ margin: 0 }}>- Họ tên người trả hàng: <b style={{ textTransform: 'uppercase', color: '#000' }}>{employeeName}</b></Typography>
                            <Typography gutterBottom sx={{ margin: 0 }}>- Bộ phận: <b style={{ color: '#000' }}>Kỹ thuật CĐBR</b></Typography>
                        </Box>

                        <Typography fontWeight="bold" mt={1} mb={0.5} sx={{ color: '#1976d2' }}>2. BÊN NHẬN (NHẬP KHO):</Typography>
                        <Box ml={3}>
                            <Typography gutterBottom sx={{ margin: 0 }}>- Đơn vị: <b style={{ color: '#000' }}>Kho ACT - Khu vực Bắc Sài Gòn</b></Typography>
                            <Typography gutterBottom sx={{ margin: 0 }}>- Người nhận: <b style={{ textTransform: 'uppercase', color: '#000' }}>{receiverName}</b></Typography>
                        </Box>
                    </Box>
                    ...
                    <Box display="flex" justifyContent="space-between" mt={1}>
                        <Box textAlign="center" width="45%">
                            <Typography fontWeight="bold" fontSize={12} sx={{ color: '#1976d2' }}>NGƯỜI GIAO HÀNG</Typography>
                            <Typography fontStyle="italic" fontSize={11}>(Ký, ghi rõ họ tên)</Typography>
                            <Box height={70} />
                            <Typography fontWeight="bold" fontSize={12} sx={{ textTransform: 'uppercase' }}>{employeeName}</Typography>
                        </Box>
                        <Box textAlign="center" width="45%">
                            <Typography fontWeight="bold" fontSize={12} sx={{ color: '#1976d2' }}>THỦ KHO</Typography>
                            <Typography fontStyle="italic" fontSize={11}>(Ký, ghi rõ họ tên)</Typography>
                            <Box height={70} />
