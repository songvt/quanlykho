...
const UploadInventoryNV: React.FC = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            // Gửi dữ liệu lên API
            const response = await fetch('/api/upload_inventory_nv', {
                method: 'POST',
    ...
    return (
        <Box sx={{ p: 3, maxWidth: 800, margin: '0 auto' }}>
            <Typography variant="h5" sx={{ mb: 3, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 1 }}>
                <Upload size={24} color="#3b82f6" /> Upload tồn kho NV
            </Typography>
            ...
            <Paper sx={{ p: 4, borderRadius: 2, bgcolor: 'background.paper', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
                <Typography variant="body1" sx={{ mb: 2, color: 'text.secondary' }}>
                    ...
                    <br />
                    <strong>Sheet:</strong> Q12-BCCS-NV (Dán từ A2:I)
                </Typography>
...
export default UploadInventoryNV;
