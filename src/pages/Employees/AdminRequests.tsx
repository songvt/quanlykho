        ...
        >
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 0.5 }}>
                ...
                <Box sx={{ width: '55%', textAlign: 'center' }}>
                    ...
                    <Typography sx={{ fontStyle: 'italic', fontSize: '10pt', mt: 0.25, fontFamily: "'Times New Roman', Times, serif", textAlign: 'right', pr: 2 }}>
            ...
            {/* Content Body */}
            <Stack spacing={0.5} sx={{ mb: 0.5, fontSize: '11pt', lineHeight: 1.35 }}>
